...
double [] d= new double[(30) * (3)];
double [] resid= new double[(256)];
double [] v= new double[(256) * (30)];
double [] workd= new double[((3*256))];
double [] workev= new double[((3*30))];
double [] workl= new double[((((3*30)*30)+(6*30)))];
...
rvec = true;
// c
org.netlib.arpack.Dneupd.dneupd(rvec,"A",select,0,d,0,d,(1-(1))+(2-(1)) * (30),v,0,256,sigmar,sigmai,workev,0,bmat,n,which,nev,tol.val,resid,0,ncv,v,0,256,iparam,0,ipntr,0,workd,0,workl,0,lworkl,ierr);
// c
// c        %------------------------------------------------%
...
org.netlib.blas.Daxpy.daxpy(n,(-(d[(j-(1))+(1-(1)) * (30)])),v,(1-(1))+(j-(1)) * (256),1,ax,0,1);
d[(j-(1))+(3-(1)) * (30)] = org.netlib.blas.Dnrm2.dnrm2(n,ax,0,1);
...
Av.av(nx,v,(1-(1))+(j-(1)) * (256),ax,0);
org.netlib.blas.Daxpy.daxpy(n,(-(d[(j-(1))+(1-(1)) * (30)])),v,(1-(1))+(j-(1)) * (256),1,ax,0,1);
org.netlib.blas.Daxpy.daxpy(n,d[(j-(1))+(2-(1)) * (30)],v,(1-(1))+((j+1)-(1)) * (256),1,ax,0,1);
d[(j-(1))+(3-(1)) * (30)] = org.netlib.blas.Dnrm2.dnrm2(n,ax,0,1);
Av.av(nx,v,(1-(1))+((j+1)-(1)) * (256),ax,0);
org.netlib.blas.Daxpy.daxpy(n,(-(d[(j-(1))+(2-(1)) * (30)])),v,(1-(1))+(j-(1)) * (256),1,ax,0,1);
org.netlib.blas.Daxpy.daxpy(n,(-(d[(j-(1))+(1-(1)) * (30)])),v,(1-(1))+((j+1)-(1)) * (256),1,ax,0,1);
d[(j-(1))+(3-(1)) * (30)] = org.netlib.lapack.Dlapy2.dlapy2(d[(j-(1))+(3-(1)) * (30)],org.netlib.blas.Dnrm2.dnrm2(n,ax,0,1));
d[(j-(1))+(3-(1)) * (30)] = (d[(j-(1))+(3-(1)) * (30)]/org.netlib.lapack.Dlapy2.dlapy2(d[(j-(1))+(1-(1)) * (30)],d[(j-(1))+(2-(1)) * (30)]));
...
// c           %-----------------------------%
// c
org.netlib.arpack.Dmout.dmout(6,nconv,3,d,0,30,-6,"Ritz values (Real, Imag) and residual residuals");
}              //  Close else.
// c
// c        %-------------------------------------------%
...
// c
label9000:
   Dummy.label("Dnsimp",9000);
// c
Dummy.label("Dnsimp",999999);
return;
   }
} // End class.
