...
// c         where A and M are obtained from the finite element discretriza
...
if ((n > 256))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" ERROR with _SDRV4: N is greater than MAXN "));
Util.f77write(null, __io_vec);
Dummy.go_to("Ssdrv4",9000);
}
else if ((nev.val > 10))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" ERROR with _SDRV4: NEV is greater than MAXNEV "));
Util.f77write(null, __io_vec);
Dummy.go_to("Ssdrv4",9000);
}              // Close else if()
else if ((ncv > 25))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" ERROR with _SDRV4: NCV is greater than MAXNCV "));
Util.f77write(null, __io_vec);
Dummy.go_to("Ssdrv4",9000);
}              // Close else if()
bmat = "G";
...
if ((ierr.val != 0))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" Error with _gttrf in _SDRV4."));
Util.f77write(null, __io_vec);
Dummy.go_to("Ssdrv4",9000);
}
// c
...
Util.f77write(null, __io_vec);
__io_vec.clear();
  __io_vec.addElement(new String(" Error with _gttrs in _SDRV4. "));
Util.f77write(null, __io_vec);
__io_vec.clear();
  __io_vec.addElement(new String(" "));
Util.f77write(null, __io_vec);
...
// c           %-----------------------------------------%
// c
org.netlib.blas.Scopy.scopy(n,workd,(ipntr[(3-(1))]-(1)),1,workd,(ipntr[(2-(1))]-(1)),1);
org.netlib.lapack.Sgttrs.sgttrs("Notranspose",n,1,adl,0,ad,0,adu,0,adu2,0,ipiv,0,workd,(ipntr[(2-(1))]-(1)),n,ierr);
if ((ierr.val != 0))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" "));
...
// c              %---------------------------%
// c  
Av.av(n,v,(1-(1))+(j-(1)) * (256),workd,0);
Mv.mv(n,v,(1-(1))+(j-(1)) * (256),workd,((n+1)-(1)));
org.netlib.blas.Saxpy.saxpy(n,(-(d[(j-(1))+(1-(1)) * (25)])),workd,((n+1)-(1)),1,workd,0,1);
d[(j-(1))+(2-(1)) * (25)] = org.netlib.blas.Snrm2.snrm2(n,workd,0,1);
d[(j-(1))+(2-(1)) * (25)] = (d[(j-(1))+(2-(1)) * (25)]/Math.abs(d[(j-(1))+(1-(1)) * (25)]));
// c
Dummy.label("Ssdrv4",30);
}              //  Close for() loop. 
}
// c
...
Util.f77write(null, __io_vec);
__io_vec.clear();
  __io_vec.addElement(new String(" _SDRV4 "));
Util.f77write(null, __io_vec);
__io_vec.clear();
  __io_vec.addElement(new String(" ====== "));
Util.f77write(null, __io_vec);
...
// c
label9000:
   Dummy.label("Ssdrv4",9000);
// c
Dummy.label("Ssdrv4",999999);
return;
   }
} // End class.
