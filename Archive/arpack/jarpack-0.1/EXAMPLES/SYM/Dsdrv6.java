...
org.netlib.blas.Daxpy.daxpy(n,sigma,temp,0,1,workd,(ipntr[(2-(1))]-(1)),1);
// c
...
// c
Av.av(n,workd,(ipntr[(1-(1))]-(1)),workd,(ipntr[(2-(1))]-(1)));
org.netlib.blas.Daxpy.daxpy(n,sigma,workd,(ipntr[(3-(1))]-(1)),1,workd,(ipntr[(2-(1))]-(1)),1);
org.netlib.lapack.Dgttrs.dgttrs("Notranspose",n,1,adl,0,ad,0,adu,0,adu2,0,ipiv,0,workd,(ipntr[(2-(1))]-(1)),n,ierr);
if ((ierr.val != 0))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" "));
...
// c
label9000:
   Dummy.label("Dsdrv6",9000);
// c
Dummy.label("Dsdrv6",999999);
return;
   }
} // End class.
