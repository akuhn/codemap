...
// c            %-----------------------------%
// c
org.netlib.arpack.Dmout.dmout(6,nconv,3,d,0,30,-6,"Ritz values (Real,Imag) and relative residuals");
}              //  Close else.
// c
// c        %-------------------------------------------%
...
// c
label9000:
   Dummy.label("Dndrv1",9000);
// c
Dummy.label("Dndrv1",999999);
return;
   }
} // End class.
