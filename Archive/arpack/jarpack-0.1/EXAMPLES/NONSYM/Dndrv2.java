...
// c     %----------------------------------------------------%
// c
dndrv2_convct.rho.val = 1.0e+1;
h = (1.0/(double)((n+1)));
s = ((dndrv2_convct.rho.val*h)/2.0);
// c
s1 = (-1.0-s);
s2 = (2.0-sigmar);
s3 = (-1.0+s);
...
// c           %-------------------------------------------%
// c
org.netlib.blas.Dcopy.dcopy(n,workd,(ipntr[(1-(1))]-(1)),1,workd,(ipntr[(2-(1))]-(1)),1);
// c
...
Av.av(n,v,(1-(1))+(j-(1)) * (256),ax,0);
org.netlib.blas.Daxpy.daxpy(n,(-(d[(j-(1))+(1-(1)) * (25)])),v,(1-(1))+(j-(1)) * (256),1,ax,0,1);
org.netlib.blas.Daxpy.daxpy(n,d[(j-(1))+(2-(1)) * (25)],v,(1-(1))+((j+1)-(1)) * (256),1,ax,0,1);
d[(j-(1))+(3-(1)) * (25)] = org.netlib.blas.Dnrm2.dnrm2(n,ax,0,1);
Av.av(n,v,(1-(1))+((j+1)-(1)) * (256),ax,0);
org.netlib.blas.Daxpy.daxpy(n,(-(d[(j-(1))+(2-(1)) * (25)])),v,(1-(1))+(j-(1)) * (256),1,ax,0,1);
org.netlib.blas.Daxpy.daxpy(n,(-(d[(j-(1))+(1-(1)) * (25)])),v,(1-(1))+((j+1)-(1)) * (256),1,ax,0,1);
...
// c
label9000:
   Dummy.label("Dndrv2",9000);
// c
Dummy.label("Dndrv2",999999);
return;
   }
} // End class.
