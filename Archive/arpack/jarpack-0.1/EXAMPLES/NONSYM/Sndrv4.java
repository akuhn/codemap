...
// c     %--------------------------------------------------%
// c
sndrv4_convct.rho.val = 1.0E+1f;
h = (1.0f/(float)((n+1)));
s = (sndrv4_convct.rho.val/2.0f);
// c
s1 = (((-((1.0f/h)))-s)-((sigmar*h)/6.0f));
s2 = ((2.0f/h)-(((4.0E+0f*sigmar)*h)/6.0f));
...
// c
label9000:
   Dummy.label("Sndrv4",9000);
// c
Dummy.label("Sndrv4",999999);
return;
   }
} // End class.
