...
double [] workl= new double[((((3*50)*50)+(6*50)))];
...
Dummy.label("Dsbdr2",40);
}              //  Close for() loop. 
}
Dummy.label("Dsbdr2",50);
}              //  Close for() loop. 
}
// c
// c     %------------------------------------%
...
a[(isub-(1))+(j-(1)) * (50)] = (-((1.0/h2)));
Dummy.label("Dsbdr2",70);
}              //  Close for() loop. 
}
Dummy.label("Dsbdr2",80);
}              //  Close for() loop. 
}
// c
// c     %-------------------------------------%
...
// c
label9000:
   Dummy.label("Dsbdr2",9000);
Dummy.label("Dsbdr2",999999);
return;
   }
} // End class.
