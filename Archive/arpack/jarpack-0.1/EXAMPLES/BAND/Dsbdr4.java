...
if ((n > 1000))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" ERROR with _SBDR4: N is greater than MAXN "));
Util.f77write(null, __io_vec);
Dummy.go_to("Dsbdr4",9000);
}
else if ((nev.val > 25))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" ERROR with _SBDR4: NEV is greater than MAXNEV "));
Util.f77write(null, __io_vec);
Dummy.go_to("Dsbdr4",9000);
}              // Close else if()
else if ((ncv > 50))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" ERROR with _SBDR4: NCV is greater than MAXNCV "));
Util.f77write(null, __io_vec);
Dummy.go_to("Dsbdr4",9000);
}              // Close else if()
bmat = "G";
...
Util.f77write(null, __io_vec);
__io_vec.clear();
  __io_vec.addElement(new String(" _SBDR4 "));
Util.f77write(null, __io_vec);
__io_vec.clear();
  __io_vec.addElement(new String(" ====== "));
Util.f77write(null, __io_vec);
...
// c
label9000:
   Dummy.label("Dsbdr4",9000);
Dummy.label("Dsbdr4",999999);
return;
   }
} // End class.
