...
public static void ssband (boolean rvec,
String howmny,
...
float sigma,
int n,
float [] ab, int _ab_offset,
float [] mb, int _mb_offset,
int lda,
float [] rfac, int _rfac_offset,
int kl,
int ku,
String which,
String bmat,
...
// c         %----------------------------------%
// c
org.netlib.lapack.Slacpy.slacpy("A",ibot,n,ab,_ab_offset,lda,rfac,_rfac_offset,lda);
{
for (j = 1; j <= n; j++) {
rfac[(imid-(1))+(j-(1)) * (lda)+ _rfac_offset] = (ab[(imid-(1))+(j-(1)) * (lda)+ _ab_offset]-sigma);
Dummy.label("Ssband",10);
}              //  Close for() loop. 
}
org.netlib.lapack.Sgbtrf.sgbtrf(n,n,kl,ku,rfac,_rfac_offset,lda,iwork,_iwork_offset,ierr);
if ((ierr.val != 0))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" "));
Util.f77write(null, __io_vec);
...
// c        %----------------------------------------------%
// c
org.netlib.lapack.Slacpy.slacpy("A",ibot,n,mb,_mb_offset,lda,rfac,_rfac_offset,lda);
org.netlib.lapack.Sgbtrf.sgbtrf(n,n,kl,ku,rfac,_rfac_offset,lda,iwork,_iwork_offset,ierr);
if ((ierr.val != 0))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" "));
...
Dummy.label("Ssband",50);
}              //  Close for() loop. 
}
Dummy.label("Ssband",60);
}              //  Close for() loop. 
}
// c
org.netlib.lapack.Sgbtrf.sgbtrf(n,n,kl,ku,rfac,_rfac_offset,lda,iwork,_iwork_offset,ierr);
...
// c
label90:
   Dummy.label("Ssband",90);
// c
org.netlib.arpack.Ssaupd.ssaupd(ido,bmat,n,which,nev.val,tol,resid,_resid_offset,ncv,v,_v_offset,ldv,iparam,_iparam_offset,ipntr,0,workd,_workd_offset,workl,_workl_offset,lworkl,info);
// c
if ((ido.val == -1))  {
    // c
if ((type == 1))  {
...
// c           %----------------------------%
// c
org.netlib.blas.Sgbmv.sgbmv("Notranspose",n,n,kl,ku,1.0f,ab,(itop-(1))+(1-(1)) * (lda)+ _ab_offset,lda,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,0.0f,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
// c
}
else if ((type == 2))  {
    // c
...
// c           %----------------------------------%
// c
org.netlib.blas.Scopy.scopy(n,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
org.netlib.lapack.Sgbtrs.sgbtrs("Notranspose",n,kl,ku,1,rfac,_rfac_offset,lda,iwork,_iwork_offset,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,n,ierr);
if ((ierr.val != 0))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" "));
Util.f77write(null, __io_vec);
...
// c
org.netlib.blas.Sgbmv.sgbmv("Notranspose",n,n,kl,ku,1.0f,ab,(itop-(1))+(1-(1)) * (lda)+ _ab_offset,lda,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,0.0f,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
org.netlib.blas.Scopy.scopy(n,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1);
org.netlib.lapack.Sgbtrs.sgbtrs("Notranspose",n,kl,ku,1,rfac,_rfac_offset,lda,iwork,_iwork_offset,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,n,ierr);
if ((ierr.val != 0))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" "));
...
// c           %-----------------------------------------%
// c
org.netlib.blas.Sgbmv.sgbmv("Notranspose",n,n,kl,ku,1.0f,mb,(itop-(1))+(1-(1)) * (lda)+ _mb_offset,lda,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,0.0f,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
org.netlib.lapack.Sgbtrs.sgbtrs("Notranspose",n,kl,ku,1,rfac,_rfac_offset,lda,iwork,_iwork_offset,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,n,ierr);
if ((ierr.val != 0))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" "));
...
if ((bmat.regionMatches(0, "G", 0, 1) ))  {
    org.netlib.blas.Sgbmv.sgbmv("Notranspose",n,n,kl,ku,1.0f,ab,(itop-(1))+(1-(1)) * (lda)+ _ab_offset,lda,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,0.0f,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
org.netlib.blas.Sgbmv.sgbmv("Notranspose",n,n,kl,ku,sigma,mb,(itop-(1))+(1-(1)) * (lda)+ _mb_offset,lda,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,1.0f,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
}
else  {
  org.netlib.blas.Scopy.scopy(n,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
org.netlib.blas.Sgbmv.sgbmv("Notranspose",n,n,kl,ku,1.0f,ab,(itop-(1))+(1-(1)) * (lda)+ _ab_offset,lda,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,sigma,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
}              //  Close else.
// c
org.netlib.lapack.Sgbtrs.sgbtrs("Notranspose",n,kl,ku,1,rfac,_rfac_offset,lda,iwork,_iwork_offset,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,n,ierr);
// c
...
// c           %-------------------------------------%
// c
org.netlib.blas.Scopy.scopy(n,workd,(ipntr[(3-(1))]-(1))+ _workd_offset,1,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
org.netlib.lapack.Sgbtrs.sgbtrs("Notranspose",n,kl,ku,1,rfac,_rfac_offset,lda,iwork,_iwork_offset,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,n,ierr);
if ((ierr.val != 0))  {
    __io_vec.clear();
  __io_vec.addElement(new String(" "));
...
if ((bmat.regionMatches(0, "G", 0, 1) ))  {
    org.netlib.blas.Sgbmv.sgbmv("Notranspose",n,n,kl,ku,1.0f,ab,(itop-(1))+(1-(1)) * (lda)+ _ab_offset,lda,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,0.0f,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
org.netlib.blas.Saxpy.saxpy(n,sigma,workd,(ipntr[(3-(1))]-(1))+ _workd_offset,1,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
}
else  {
  org.netlib.blas.Scopy.scopy(n,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
org.netlib.blas.Sgbmv.sgbmv("Notranspose",n,n,kl,ku,1.0f,ab,(itop-(1))+(1-(1)) * (lda)+ _ab_offset,lda,workd,(ipntr[(1-(1))]-(1))+ _workd_offset,1,sigma,workd,(ipntr[(2-(1))]-(1))+ _workd_offset,1);
...
if ((iparam[(5-(1))+ _iparam_offset] > 0))  {
    // c
org.netlib.arpack.Sseupd.sseupd(rvec,"A",select,_select_offset,d,_d_offset,z,_z_offset,ldz,sigma,bmat,n,which,nev,tol.val,resid,_resid_offset,ncv,v,_v_offset,ldv,iparam,_iparam_offset,ipntr,0,workd,_workd_offset,workl,_workl_offset,lworkl,info);
// c
if ((info.val != 0))  {
    // c 
// c                 %------------------------------------%
...
// c     %----------------------------------------%
// c
Dummy.go_to("Ssband",90);
// c
label9000:
   Dummy.label("Ssband",9000);
// c
Dummy.label("Ssband",999999);
return;
   }
} // End class.
