...
//        }
    ...
    private void update_stress () {
        ...
        if (stress_dd * stress_xx > delta*delta) {
            ...
            // FIXME remove comments, find out what's going on ...
//            PrintfFormat format = new PrintfFormat("didn't draw stress: stress_dx = %5.5g   stress_dd = %5.5g   stress_xx = %5.5g\n");
//            throw new Error(format.sprintf(stress_dx, stress_dd, stress_xx));
        }
    } /* end update_stress() */
