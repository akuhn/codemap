...
//        addEdgePoints(points);
        ...
        colors.setColor("MapPerProject", new MColor(255, 0, 0));
        ...
        System.out.println(mapInstance.nearestNeighbor(658, 483).getDocument());
    }
    
    private static void addDebugPoints(HashMap<Point, Integer> points) {
        ...
        points.put(new Point(0.7268853978776577, 0.34759922840797425, "MapSelectionProvider"), 63);
        points.put(new Point(0.3153878368460545, 0.08067768290234456, "DropDownAction"), 34);
        points.put(new Point(0.4950288573576329, 0.6365531563547007, "ColorDropDownAction"), 27);
        points.put(new Point(0.39681256560753997, 0.43624738334256963, "CodemapLabels"), 29);
        points.put(new Point(0.2997628719618165, 0.8839712425057394, "SelectionTracker"), 57);
        points.put(new Point(0.19526143925582534, 0.7973625155288466, "ICodemapPluginAction"), 11);
        points.put(new Point(0.6489117292694555, 0.5396422786708468, "MapPerProject"), 71);
        points.put(new Point(0.5774641824500757, 0.05, "ExtensionPoints"), 13);
        points.put(new Point(0.38288951566521523, 0.9109339389285401, "Icons"), 36);
        ...
        points.put(new Point(0.05, 0.5247563995404056, "EclipseTaskFactory"), 42);
        points.put(new Point(0.8938838884307299, 0.6124397498165601, "LabelDrowDownAction"), 21);
        points.put(new Point(0.6960067092724127, 0.15550769422331862, "CodemapCore"), 53);
