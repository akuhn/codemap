...
class MethodReference {
	...
	private static class Resolver {
		...
		private Method resolveMethod(Class jclass, String simple, String[] args) throws Exception {
			return args == null 
					? this.resolveAmbigousMethod(jclass, simple) 
					: jclass.getMethod(simple, this.getParameterClasses(args));
		}
	...
	public String toString() {
		...
		if (args != null) {
			...
			for (String each : args) $.append(s).append(each);
			$.append(')');
		}
		return $.toString();
	}
