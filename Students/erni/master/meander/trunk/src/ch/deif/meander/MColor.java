...
/**
 * Custom color class used to provide in-place modification of color values for
 * performance reasons
 */
public class MColor {
    ...
    /**
     * handles an 32bit rgb mem layout: 8 bit alpha, 8 bit red, 8 bit g, 8 bit b
     * aaaaaaaarrrrrrrrggggggggbbbbbbbb
     * 
     * alpha is all set to 1 if there is no alpha r needs 16 bit shift g needs 8
     * bit shift b needs no shift
     */
    public int rgb() {
