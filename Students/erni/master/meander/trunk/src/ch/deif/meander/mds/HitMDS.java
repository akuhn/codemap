...
/**
 * @author spupyrev 20.11.2008 Multidimensional Scaling according to best distance matrix reconstruction. Based on signs
 *         of directions to maximize correlation
 */
...
public class HitMDS {
	...
	private void mds_train(int cycles, double learning_rate) {
		...
		for (c = 0; c < cycles; c++) {
			if (++t == m) {
				t = 0;
				debug_print(100.0 * c / cycles + "%: " + corr_2() + " \t(r = " + 1.0 / sqrt(corr_2() + 1.0) + ")");
			}
