...
public class ComputeElementsTask extends JobValue<Collection<String>> {
    
    public ComputeElementsTask(String name, Value<Collection<String>> projects, Value<Collection<String>> extensions) {
        super("Compute elements of " + name, projects, extensions);
    }
