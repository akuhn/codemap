...
org.netlib.blas.Daxpy.daxpy(n,(-(d[(j-(1))+(1-(1)) * (25)])),workd,((n+1)-(1)),1,workd,0,1);
d[(j-(1))+(2-(1)) * (25)] = org.netlib.blas.Dnrm2.dnrm2(n,workd,0,1);
d[(j-(1))+(2-(1)) * (25)] = (d[(j-(1))+(2-(1)) * (25)]/Math.abs(d[(j-(1))+(1-(1)) * (25)]));
// c
Dummy.label("Dsdrv4",30);
}              //  Close for() loop. 
}
// c
...
// c
label9000:
   Dummy.label("Dsdrv4",9000);
// c
Dummy.label("Dsdrv4",999999);
return;
   }
} // End class.
